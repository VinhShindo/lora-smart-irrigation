-- ==========================================
-- SMART GARDEN - LEAN OPTIMIZED SCHEMA
-- ==========================================
...
-- =====================================================
-- 2️⃣ TRẠNG THÁI HIỆN TẠI NODE (SNAPSHOT)
-- =====================================================

CREATE TABLE node_status (
    node_id TEXT PRIMARY KEY 
        REFERENCES devices(node_id) ON DELETE CASCADE,
...
-- =====================================================
-- 3️⃣ LỊCH SỬ TRẠNG THÁI NODE (GỘP RSSI)
-- =====================================================
...
CREATE TABLE device_status_history (
    ...
    component_id TEXT 
        REFERENCES device_status(component_id) ON DELETE CASCADE,

    node_id TEXT 
        REFERENCES devices(node_id),
